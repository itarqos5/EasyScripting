...
EasyScripting 0.2.5 provides configurable group movement and combat. Each NPC owns its health, equipment and carried supplies. A group supplies orders, allies and optional shared defaults; it does not pool health, inventories, hunger or XP, and it does not choose a winner in advance. Paper handles damage, armor, potion effects, knockback and death. PLAYER actors require a Citizens build for your server version.
